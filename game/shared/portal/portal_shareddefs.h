...
#define PORTAL_HALF_HEIGHT 56.0f
...
// Names used by the older server portal-gun implementation.
#define PORTAL_ANALOG_SUCCESS_NO_BUMP PORTAL_PLACEMENT_SUCCESS
#define PORTAL_ANALOG_SUCCESS_NEAR PORTAL_PLACEMENT_USED_HELPER
#define PORTAL_ANALOG_SUCCESS_OVERLAP_LINKED PORTAL_PLACEMENT_OVERLAP_LINKED
#define PORTAL_ANALOG_SUCCESS_PASSTHROUGH_SURFACE PORTAL_PLACEMENT_PASSTHROUGH_SURFACE
#define PORTAL_ANALOG_SUCCESS_CANT_FIT PORTAL_PLACEMENT_CANT_FIT
#define PORTAL_ANALOG_SUCCESS_CLEANSER PORTAL_PLACEMENT_CLEANSER
#define PORTAL_ANALOG_SUCCESS_INVALID_VOLUME PORTAL_PLACEMENT_INVALID_VOLUME
#define PORTAL_ANALOG_SUCCESS_INVALID_SURFACE PORTAL_PLACEMENT_INVALID_SURFACE
#define PORTAL_ANALOG_SUCCESS_BUMPED PORTAL_PLACEMENT_BUMPED
