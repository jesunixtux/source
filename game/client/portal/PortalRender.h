...
public:
	...
	void DrawPortalsToTextures( CViewRender *pViewRender, const CViewSetup &viewSetup ) { (void)pViewRender; (void)viewSetup; }
	bool ShouldUseStencilsToRenderPortals() const { return true; }
