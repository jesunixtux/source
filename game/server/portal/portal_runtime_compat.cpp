...
// The mutable implementation is provided by weapon_physcannon.cpp. Declare
// the overload before this wrapper so overload resolution cannot recurse into
// the const overload indefinitely.
...
bool PortalPlacementSucceeded(PortalPlacementResult_t r)
{
	return r == PORTAL_PLACEMENT_SUCCESS ||
		r == PORTAL_PLACEMENT_USED_HELPER ||
		r == PORTAL_PLACEMENT_BUMPED;
}
