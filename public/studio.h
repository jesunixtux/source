...
#define MAXSTUDIOBONES		256		// Portal 2 container debris uses up to 248 bones
...
#define MAXSTUDIOBONEBITS	8		// NOTE: MUST MATCH MAXSTUDIOBONES; rebuild all modules together
