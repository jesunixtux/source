...
enum TitleDlcSupportedPlatform_t
{
	DLC_POSIX				= ( 1 << 0 ),							// This DLC is supported on PC/OSX/LINUX
	DLC_PS3					= ( 1 << 2 ),							// This DLC is supported on PS3
	DLC_X360				= ( 1 << 3 ),							// This DLC is supported on X360
	DLC_ALL_PLATFORMS		= ( DLC_POSIX | DLC_PS3 | DLC_X360 )	// This DLC is supported by all platforms
};
